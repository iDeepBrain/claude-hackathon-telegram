...
def make_context(redis_raises: bool = False, args: list[str] | None = None) -> tuple:
    """Returns (context, redis_mock). If redis_raises=True, redis.set raises Exception.

    `args` defaults to an empty list so /start handlers that read
    ``context.args`` get a real iterable, not a MagicMock attribute
    auto-generated by spec=None.
    """
